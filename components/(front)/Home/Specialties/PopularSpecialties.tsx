    ...
    <div className="container p-4 mx-auto">
      <div className="flex max-xl:flex-col items-center justify-between mb-8 gap-4">
        ...
        <Link
          ...
          className="flex items-center gap-2 bg-gradient-to-r from-sitePrimary to-sitePrimary/70 text-white max-xl:w-full justify-center px-6 xl:px-8 py-3 xl:py-4 rounded-md font-semibold hover:from-sitePrimary hover:to-sitePrimary transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5"
        >
          <span className="text-sm xl:text-base">{t("Tüm Branşları Gör")}</span>
        </Link>
      </div>
