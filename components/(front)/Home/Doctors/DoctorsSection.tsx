  ...
  return (
    <section className="mb-16" aria-labelledby="featured-doctors-heading">
      <div className="text-center mb-8">
        <h2 id="featured-doctors-heading" className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
          Öne Çıkan Doktorlar
        </h2>
      ...
      <div className="relative px-12">
        ...
        >
          {doctors.slice(0, 8).map((doctor) => (
            <SwiperSlide key={doctor.id} className="lg:py-6 py-4">
        ...
        {/* Navigation Buttons */}
        <button className="doctors-swiper-prev absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-10 h-10 bg-white rounded-full shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center text-gray-600 hover:text-blue-600">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          </svg>
        </button>
        <button className="doctors-swiper-next absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-10 h-10 bg-white rounded-full shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center text-gray-600 hover:text-blue-600">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
