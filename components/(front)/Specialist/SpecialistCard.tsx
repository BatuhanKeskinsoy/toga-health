    ...
    <div className="flex flex-col w-full bg-white rounded-t-md">
      <div className="flex justify-between gap-2 w-full">
        <div className="flex items-center gap-4 p-4 w-full">
          <div className="relative rounded-md overflow-hidden shadow-md shadow-gray-200 group">
            <ProfilePhoto size={140} name="Ahmet Yılmaz" fontSize={40} />
          ...
          <div className="flex flex-col gap-3 text-sm">
            ...
            <Link
              ...
              className="text-xs opacity-70 hover:text-sitePrimary transition-all duration-300"
            >
        ...
        <div className="flex flex-col items-end p-4 max-lg:w-full lg:min-w-max">
      ...
      <div className="flex w-full gap-2 items-center justify-end p-3 text-sm">
        <CustomButton
